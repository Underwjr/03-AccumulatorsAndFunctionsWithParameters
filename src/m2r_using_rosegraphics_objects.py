...
#              In the middle of the screen horizontally and vertically
#
...
#            window = rg.RoseWindow(15, 100, 'window whose height is 100')
#
...
#           Draws all of the objects attached to window
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            So you can close your program without finishing it out
#
